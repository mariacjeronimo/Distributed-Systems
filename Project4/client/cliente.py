...
while True:
    ...
    if len(mensagem) == 0:
        ...
        if info[1] == "UTILIZADOR" and len(info) == 4:
            ...
            time.sleep(0.01)
            resp = requests.put(url, data = dados, headers = {'Content-type': 'application/json'}, verify='../certs/root.pem', cert=('../certs/cli.crt','../certs/cli.key'))
            ...
            url = ('https://localhost:5000/artistas')
            ...
            url = ('https://localhost:5000/musicas')
            ...
            if len(info) == 4:
                ...
                print(avaliacoes)
                url = ('https://localhost:5000/utilizadores/playlist') 
        ...
        if len(info) == 3:
            if info[1] == "UTILIZADOR":
                ...
                url = ('https://localhost:5000/utilizadores/' + str(id_user))
                dados = json.dumps(utilizadores)
                print("Dados enviados: " + dados)
                time.sleep(0.01)
                resp = requests.get(url, data = dados, headers = {'Content-type': 'application/json'}, verify='../certs/root.pem', cert=('../certs/cli.crt','../certs/cli.key'))
                ...
                url = ('https://localhost:5000/artistas/' + str(id_artista))
                dados = json.dumps(artistas)
                print("Dados enviados: " + dados)
                time.sleep(0.01)
                resp = requests.get(url, data = dados, headers = {'Content-type': 'application/json'}, verify='../certs/root.pem', cert=('../certs/cli.crt','../certs/cli.key'))
                ...
                try:
                    ...
                    url = ('https://localhost:5000/musicas/' + str(id_musica))
                    dados = json.dumps(musicas)
                    print("Dados enviados: " + dados)
                    time.sleep(0.01)
                    resp = requests.get(url, data = dados, headers = {'Content-type': 'application/json'}, verify='../certs/root.pem', cert=('../certs/cli.crt','../certs/cli.key'))
                ...
                if info[2] == "UTILIZADORES": 
                    ...
                    #time.sleep(0.01)
                    resp = requests.get(url, headers = {'Content-type': 'application/json'}, verify='../certs/root.pem', cert=('../certs/cli.crt','../certs/cli.key'))
#
                    ...
                    url = ('https://localhost:5000/artistas/all')
                    time.sleep(0.01)
                    resp = requests.get(url, headers = {'Content-type': 'application/json'}, verify='../certs/root.pem', cert=('../certs/cli.crt','../certs/cli.key'))
                    ...
                    url = ('https://localhost:5000/musicas/all')
                    time.sleep(0.01)
                    resp = requests.get(url, headers = {'Content-type': 'application/json'}, verify='../certs/root.pem', cert=('../certs/cli.crt','../certs/cli.key'))
            ...
            if info[1] == "ALL":
                if info[2] == "MUSICAS_A":
                    ...
                    url = ('https://localhost:5000/musicas/all/artista/' + str(id_artista) ) 
                    dados = json.dumps(musicas)
                    print("Dados enviados: " + dados)
                    time.sleep(0.01)
                    resp = requests.get(url, data = dados, headers = {'Content-type': 'application/json'}, verify='../certs/root.pem', cert=('../certs/cli.crt','../certs/cli.key'))
                    ...
                    url = ('https://localhost:5000/musicas/all/utilizador/'+ str(id_user))
                    dados = json.dumps(musicas)
                    print("Dados enviados: " + dados)
                    time.sleep(0.01)
                    resp = requests.get(url, data = dados, headers = {'Content-type': 'application/json'}, verify='../certs/root.pem', cert=('../certs/cli.crt','../certs/cli.key'))
                    ...
                    url = ('https://localhost:5000/musicas/all/avaliacao')
                    dados = json.dumps(musicas)
                    print("Dados enviados: " + dados)
                    time.sleep(0.01)
                    resp = requests.get(url, data = dados, headers = {'Content-type': 'application/json'}, verify='../certs/root.pem', cert=('../certs/cli.crt','../certs/cli.key'))
        ...
        if len(info) == 3:
            if info[1] == "UTILIZADOR":
                ...
                print("Dados enviados: " + dados)
                time.sleep(0.01)
                resp = requests.delete(url, data = dados, headers = {'Content-type': 'application/json'}, verify='../certs/root.pem', cert=('../certs/cli.crt','../certs/cli.key'))
                ...
                if info[2] == "UTILIZADORES":
                    url = ('https://localhost:5000/utilizadores/all/')
                    time.sleep(0.01)
                    resp = requests.delete(url, headers = {'Content-type': 'application/json'}, verify='../certs/root.pem', cert=('../certs/cli.crt','../certs/cli.key'))
        ...
        if info[1] == "MUSICA" and len(info) == 5:
            ...
            url = ('https://localhost:5000/utilizadores/playlist/'+ str(id_user))
            ...
            print ("Dados enviados: " + dados)
            time.sleep(0.01)
            resp = requests.put(url, data = dados, headers = {'Content-type': 'application/json'}, verify='../certs/root.pem', cert=('../certs/cli.crt','../certs/../certs/cli.key'))
