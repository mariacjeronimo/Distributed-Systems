...
-> Abrir dois terminais na mesma diretoria do trabalho: 
...
----------------------------------------------------------------------------------------------------
COMO TEMOS ACESSO ÀS INFORMAÇÕES VINDAS DA API DO SPOTIFY:
Em vez de gerar-mos um novo token manualmente sempre que este expira, decidimos implementar uma função que cria um novo token automaticamente.
Esta função chama-se 'generateNewOAuthToken' que através do CLIENT ID E CLIENT SECRET faz pedido do token e return do mesmo.
